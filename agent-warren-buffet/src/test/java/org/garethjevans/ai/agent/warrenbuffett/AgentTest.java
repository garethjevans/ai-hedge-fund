...
public class AgentTest {
  ...
  public void canInvokeTool() {
    ...
    assertThat(response).contains("Warren Buffett");
    response = client.prompt("What would Warren Buffett think about AVGO?").call().content();
  ...
  public SyncMcpToolCallbackProvider getSyncMcpToolCallbackProvider(ChatModel chatModel) {
    List<McpSyncClient> clients =
        List.of(getMcpSyncClient("http://localhost:10090/", ChatClient.create(chatModel)));
