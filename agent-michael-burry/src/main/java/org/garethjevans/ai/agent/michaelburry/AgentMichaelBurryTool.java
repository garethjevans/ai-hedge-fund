...
public class AgentMichaelBurryTool {
  ...
  public Map<String, MichaelBurrySignal> performAnalysisForTicker(
    ...
    for (String t : tickers) {
      ...
      //
      //        progress.update_status("michael_burry_agent", ticker, "Analyzing contrarian
      // sentiment")
      ...
      //        details.append(f"{sentiment_negative_count} negative headlines (contrarian
      // opportunity)")
      //    else:
      ...
      MichaelBurrySignal output = generateBurryOutput(t, analysisResult, toolContext);
  ...
  private MichaelBurrySignal generateBurryOutput(
