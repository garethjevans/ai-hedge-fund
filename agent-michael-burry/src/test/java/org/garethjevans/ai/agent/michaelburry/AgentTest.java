...
public class AgentTest {
  ...
  public void canInvokeTool() {
    ...
    assertThat(response).contains("Michael Burry");
    response = client.prompt("What would Michael Burry think about AVGO?").call().content();
  ...
  public SyncMcpToolCallbackProvider getSyncMcpToolCallbackProvider(ChatModel chatModel) {
    List<McpSyncClient> clients =
        List.of(getMcpSyncClient("http://localhost:10091/", ChatClient.create(chatModel)));
