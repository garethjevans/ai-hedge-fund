...
public class AgentTest {
  ...
  public void canInvokeTool() {
    ...
    assertThat(response).contains("Peter Lynch");
    response = client.prompt("What would Peter Lynch think about AVGO?").call().content();
  ...
  public SyncMcpToolCallbackProvider getSyncMcpToolCallbackProvider(ChatModel chatModel) {
    List<McpSyncClient> clients =
        List.of(getMcpSyncClient("http://localhost:10092/", ChatClient.create(chatModel)));
